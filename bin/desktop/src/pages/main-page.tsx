    ...
    return (
        <div className='flex flex-col gap-3'>
            ...
            {warnings.rates_empty && warnings.has_records_in_year && (
                <Link
                    to='/rates'
                    className='border-destructive/50 bg-destructive/10 text-destructive hover:bg-destructive/20 flex items-center gap-2 rounded-lg border px-3 py-2 text-sm transition-colors'
                >
