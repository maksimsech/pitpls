                ...
                {IMPORTERS.map((importer) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={busy !== null}
                            className="group flex w-full items-center justify-between gap-3 rounded-lg border bg-card/40 px-3 py-2.5 text-left transition-colors hover:border-foreground/20 hover:bg-muted/60 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                        >
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {isBusy ? (
                                    ...
                                    <Upload className="size-4 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100" />
                                )}
                            </div>
                        </button>
                    );
